...
- **Chain diagrams** — `docs/hook_chain_doc.md` gained Mermaid diagrams for the Regular Commit Chain, Merge Chain, Rewrite Chain, and Patch Apply Chain, plus one per Standalone Hook, covering the full set of seventeen stages
