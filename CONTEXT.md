...
examples/
  prepare-commit-msg-demo.sh      # bash demo driving `hupy prepare-commit-msg` via the real CLI;
                                    # preps its repo by shelling out to tests/fixtures/prep_repo.py
