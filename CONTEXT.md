...
| `VERSION_RELEASE` | `"Version Release: <version>"`, or plain `"Version Release"` if `grep_source_branch_version()` returns `""` |
...
examples/
  ...
  pch/                            # __init__.py (shared demo helpers) + 10 runnable demo scripts:
                                    # feature-landing, version-release, sync-backport, catch-up,
