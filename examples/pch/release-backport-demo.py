#!/usr/bin/env python3
"""
release-backport-demo.py

demo: Release Backport merge (release/2.4.0 into dev), a CBM merge
type that CBM already classifies (see hupy/cbm/commit_type.py) but
that PCH does not yet prepend a header for
...
def _prepare_demo_repo():
    ...
    _commit_file(repo, dest_dir, "changelog.py", "# freeze for 2.4.0\n")
...
def main():
    ...
    print("scenario:\tRelease Backport merge (release/2.4.0 into dev)")
