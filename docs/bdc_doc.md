...
BDC runs in the pre-commit stage — see the [Hook Flow](flow_doc.md) for where it fits — and shares its branch classification with [Commit, Branch & Merge](cbm_doc.md).
