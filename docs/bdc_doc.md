...
BDC runs in the pre-commit stage — see the [Hook Chain](hook_chain_doc.md) for where it fits — and shares its branch classification with [Commit, Branch & Merge](cbm_doc.md).
