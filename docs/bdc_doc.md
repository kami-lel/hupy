...
BDC runs in the pre-commit, pre-rebase, and pre-applypatch stages — see the [Hook Chain](chain_doc.md) for where each fits — and shares its branch classification with [Commit, Branch & Merge](cbm_doc.md).
