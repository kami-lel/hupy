"""
cli_post_applypatch.py

define ``register_cli_post_applypatch_parser``, the post-applypatch hook
subcommand
"""
...
# constants  ###################################################################
_HOOK_NAME = "post-applypatch"
_POST_APPLYPATCH_DOC = "run post-applypatch stage hooks"
...
def _post_applypatch_main(args):  ##############################################
    """
    dispatch for the ``post-applypatch`` subcommand
    """
...
# Public API  ##################################################################
def register_cli_post_applypatch_parser(subparser):
    """
    register the ``post-applypatch`` subcommand parser.
    """
    post_applypatch_parser = subparser.add_parser(
        _HOOK_NAME,
        help=_POST_APPLYPATCH_DOC,
        description=_POST_APPLYPATCH_DOC,
    )
    post_applypatch_parser.add_argument(
        "hook_args",
        nargs="*",
        help="raw arguments forwarded",
    )
    kamilog.add_verbose_arguments(post_applypatch_parser)
    post_applypatch_parser.set_defaults(func=_post_applypatch_main)
